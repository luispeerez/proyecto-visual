...
--
-- Servidor: localhost
-- Tiempo de generación: 19-11-2013 a las 00:58:33
...
CREATE TABLE IF NOT EXISTS `mesa` (
  ...
  `disponiblidad` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`idmesa`)
...
(1, 10, 4, 'Esquina superior izquierda', 'Si'),
(2, 11, 6, 'Esquina superior derecha', 'Si'),
(3, 12, 4, 'Esquina inferior derecha', 'No');
